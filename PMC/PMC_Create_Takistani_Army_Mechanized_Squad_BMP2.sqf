...
PMC_Create_Takistani_Army_Mechanized_Squad_BMP2 =
{
	private
	[
		"_grp",
	...
	_vcl = "BMP2_TK_EP1" createVehicle [(_respawnpoint select 0)+20, (_respawnpoint select 1), 0];
	...
	"TK_Soldier_MG_EP1" createUnit [_respawnpoint, _grp, "", 0.33, "CORPORAL"];
	"TK_Soldier_LAT_EP1" createUnit [_respawnpoint, _grp, "", 0.2, "CORPORAL"];
