...
if (!alive _vcl || !alive leader _HeloGrp) exitWith
{
	...
	PMC_InfTransport = PMC_InfTransport - 1;
	publicVariable "PMC_InfTransport";
	diag_log format ["Infantry Transport Airborne RU %1 has exited with catastrophic failure. alive _vcl: %2, alive leader _HeloGrp: %3, posit: %4", _HeloGrp, alive _vcl, alive leader _HeloGrp, getPos _vcl];
};
...
{
	diag_log format ["Infantry Transport Airborne RU (%1) %2 has exited with (ALL OK) alive _vcl: %3, alive leader _HeloGrp: %4. POSIT: %5, _rtb: %6", PMC_InfTransport, _HeloGrp, alive _vcl, alive leader _HeloGrp, getPos _vcl, _rtb];
	{
		deleteVehicle _x;
	} forEach units _HeloGrp;
	deleteVehicle _vcl;
...
{
	diag_log format ["Infantry Transport Airborne RU (%1) %2 has exited with (NOT OK) alive _vcl: %3, alive leader _HeloGrp: %4. POSIT: %5, _rtb: %6", PMC_InfTransport, _HeloGrp, alive _vcl, alive leader _HeloGrp, getPos _vcl, _rtb];
};
