...
PMC_Create_Takistani_Army_Motorized_Patrol =
{
	private
	[
		"_grp",
	...
	"TK_Soldier_GL_EP1" createUnit [_respawnpoint, _grp, "", 0.46, "SERGEANT"];
	
	_vcl = "UAZ_Unarmed_TK_EP1" createVehicle [(_respawnpoint select 0)+20, (_respawnpoint select 1), 0];
